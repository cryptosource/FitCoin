...
// coinvest, 구분자
const string strMessageMagic = "FitCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if (pindexBest->nHeight+1 < 43800)
	{
		// 43800 이전 채굴량
		nSubsidy = 162191 * COIN;
	}
	else
	{
		// 43800 이후 채굴량
		nSubsidy = (10 - (((int)(((pindexBest->nHeight+1)-43800)/21600))*0.02)) * COIN;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "FitCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // coinvest, 최초 시작 시간 코드
        const char* pszTimestamp = "Mon, 23 May 2016 04:37:28 +0000";
        CTransaction txNew;
        // coinvest, 최초 시작 시간
        txNew.nTime = 1463978248;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        // coinvest, 최초 시작 시간
        block.nTime    = 1463978248;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        // coinvest, nNonce
        block.nNonce   = 5145766;
		if(fTestNet)
        {
            block.nNonce   = 5032762;
        }
        // coinvest, 제네시스 블럭 생성
        ...
        //// debug print
        // coinvest, MerkleRoot
        assert(block.hashMerkleRoot == uint256("0xdc08b94cd3990c01b5a4ba872e016d98564577b42a98cbbfe5a6283cd14f82df"));
        block.print();
...
// coinvest, 메세지 스타트
unsigned char pchMessageStart[4] = { 0x3f, 0x5e, 0x7d, 0x26 };
